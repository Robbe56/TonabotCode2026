...
public class DriveOverBump extends Command {
  ...
  public DriveOverBump(CommandSwerveDrivetrain m_swerve, CommandXboxController m_driverController) {
  ...
  //if drive away home zone into neutral zone
  ...
  public boolean isFinished() {
    return !driverController.getHID().getYButton();
  }
}
